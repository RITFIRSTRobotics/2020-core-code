...
Valid TLV types are defined in table{tab:configTypes}.
...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{1cm}|p{0.04cm}|p{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|
        ...
        [0,1] & \multicolumn{32}{c|}{Header}\\
        \hline
        2 & \multicolumn{8}{c|}{Value Type} & \multicolumn{24}{c|}{Value Length}\\
        \hline
        ... & \multicolumn{32}{c|}{Arbitrary Data}\\
        \hline
        n & \multicolumn{16}{c|}{Arbitrary Data (Cont)} & \multicolumn{16}{c|}{\cellcolor[gray]{.6}...}\\
        \hline
    \end{tabular}
\end{table}
