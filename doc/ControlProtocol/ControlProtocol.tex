...
The \acrshort{fms} then responds to the robot with an empty INIT message. 
...
Since the \acrshort{fms} replies to an INIT packet from the robot with an empty INIT packet, all fields except the header are optional.  
...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{1cm}|p{0.04cm}|p{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|
        ...
        [0,1] & \multicolumn{32}{c|}{Header}\\
        \hline
        2 & \multicolumn{32}{c|}{Status Code}\\
        \hline
    \end{tabular}
\end{table}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{1cm}|p{0.04cm}|p{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|m{0.04cm}|
        ...
        [0,1] & \multicolumn{32}{c|}{Header}\\
        \hline
        2 & \multicolumn{32}{c|}{Git Commmit Hash}\\
        \hline
    ...
    \end{tabular}
\end{table}
Git Commit Hash: The hash of the current git commit of the software running on the sender.
...
In order to correctly handle this situation, the \acrshort{fms} must keep the UUID of all robots, 
